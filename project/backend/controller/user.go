...
import (
	common "niumahome/controller/Common"
...
func UserRegisterHandler(ctx *gin.Context) {
	...
	if err != nil {
		if errors.Is(err, niumahome.ErrUserExist) {
			common.ResponseError(ctx, common.CodeUserExist)
		} else if errors.Is(err, niumahome.ErrEmailExist) {
...
func UserLoginHandler(ctx *gin.Context) {
	...
	if err != nil {
		if errors.Is(err, niumahome.ErrUserNotExist) {
			common.ResponseError(ctx, common.CodeUserNotExist)
		} else if errors.Is(err, niumahome.ErrWrongPassword) {
